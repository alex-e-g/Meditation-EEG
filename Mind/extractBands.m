...
if plotting == "ON"
    subplot(6,1,1); plot(timesamples, delta); legend('delta')
    subplot(6,1,2); plot(timesamples, theta); legend('theta')
    subplot(6,1,3); plot (timesamples, alpha_lower); legend('lower alpha')
    subplot(6,1,4); plot (timesamples, alpha_upper); legend('upper alpha')
    subplot(6,1,5); plot(timesamples, beta); legend('beta')
    subplot(6,1,6); plot(timesamples, gamma); legend('gamma + noise')
